...
export function ScrollStory() {
  ...
  // Hint disappears and glides up smoothly when scrolling starts
  const hintOpacity = useTransform(scrollYProgress, [0, 0.06], [1, 0]);
  const hintY = useTransform(scrollYProgress, [0, 0.06], [0, -20]);
  ...
  return (
    <section ref={ref} className="relative" style={{ height: "800vh" }}>
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
        ...
        {/* Top Scroll Indicator with smooth leave animation */}
        <motion.div
